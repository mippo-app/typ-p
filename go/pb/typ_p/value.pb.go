...
var file_typ_p_value_proto_goTypes = []any{
...
func file_typ_p_value_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_typ_p_value_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Value); i {
			case 0:
				return &v.state
			case 1:
		...
		file_typ_p_value_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	file_typ_p_value_proto_msgTypes[0].OneofWrappers = []any{
		(*Value_BoolValue)(nil),
